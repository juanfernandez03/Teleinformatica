...
def myNetwork():
    ...
    #net.addLink(rPrincipal, switch_suc1, intfName1='rPrincipal-eth0', params1={'ip' : '192.168.100.6/24})
    net.addLink(rPrincipal, switch_suc1)
    net.addLink(rPrincipal, switch_suc2)
    net.addLink(rPrincipal, switch_suc3)
    net.addLink(rPrincipal, switch_suc4)
    net.addLink(rPrincipal, switch_suc5)
    net.addLink(rPrincipal, switch_suc6)
